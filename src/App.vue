<template>
  <v-app style="z-index: 0">
    <v-app-bar color="grey darken-3"><h2 >MovieTv</h2>
    <v-spacer></v-spacer>
      <v-toolbar-items>
        <v-btn size="x-large" v-for="(item,i) in menuItems" :key="i">  {{item.title}}</v-btn>
      </v-toolbar-items>
    </v-app-bar>
    ...
    items: [
      {
        ...
        img: './assets/UzUZ-ru-20220502-popsignuptwoweeks-perspective_alpha_website_large.jpg',
      },
      {
        title: 'Rock',
